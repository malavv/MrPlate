...
void Adafruit_SSD1306::display(void) {
	ui->writeToScreenBuffer(buffer, (SSD1306_LCDWIDTH * SSD1306_LCDHEIGHT / 8));
}
void Adafruit_SSD1306::println(const char* val) {
	print(val);
	println();
}
void Adafruit_SSD1306::print(const char* val) {
	const uint8_t len = strlen(val);
	for (uint8_t i = 0; i < len; i++)
		write(*(val+i));
}
void Adafruit_SSD1306::println(double val) {
